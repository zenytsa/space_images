...
![2.1 - Корпус объектива](https://github.com/zenytsa/SupportImages/blob/main/2.1.jpg)
...
![2.2 - Спутник CubeSat 3U](https://github.com/zenytsa/SupportImages/blob/main/2.2.jpg)
...
![2.3 - Фрагмент изображения, полученного плоским дифракционным объективом](https://github.com/zenytsa/SupportImages/blob/main/2.3.jpg)
...
![3.1 – Исходное изображение](https://github.com/zenytsa/SupportImages/blob/main/3.1.jpg)
...
![](https://github.com/zenytsa/SupportImages/blob/main/3.2(a).jpg)
![](https://github.com/zenytsa/SupportImages/blob/main/3.2(b).jpg)
...
![](https://github.com/zenytsa/SupportImages/blob/main/3.3(a).jpg)
![](https://github.com/zenytsa/SupportImages/blob/main/3.3(b).jpg)
...
![](https://github.com/zenytsa/SupportImages/blob/main/3.4(a).jpg)
![](https://github.com/zenytsa/SupportImages/blob/main/3.4(b).jpg)
...
![](https://github.com/zenytsa/SupportImages/blob/main/3.5(a).jpg)
![](https://github.com/zenytsa/SupportImages/blob/main/3.5(b).jpg)
...
![](https://github.com/zenytsa/SupportImages/blob/main/3.6(a).jpg)
![](https://github.com/zenytsa/SupportImages/blob/main/3.6(b).jpg)
...
Те же задачи, которые мы решали с помощью инструментов графического редактора, можно решать при помощи алгоритмов, где мы точно будем знать, что и как происходит с изображением. Дальше начинается медленное погружение в инженерный и научный подход к улучшению изображений. Поэтому и язык описания будет чуть строже, терминология чуть более жёсткой и появятся отсылки к научным публикациям, которые будут приведены в конце.
